...
- **Session tracking** — Counts completed sessions per day, persisted locally.
...
Reminders only fire within your configured **active hours** window (default 09:00–18:00).
...
- `tauri-plugin-store` — persistent settings and session count
